...
PICS = (environ.get('PICS', 'https://i.ibb.co/3qd9JRK/x.jpg')).split()  # Sample pic
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002051915731').split()]  # Channel id for auto indexing (make sure bot is admin)
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002565642490'))  # Notification of those who verify will be sent to your channel
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+2UUjdxPTBQc1ODll')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+2UUjdxPTBQc1ODll')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/KannadaMagaa')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+2UUjdxPTBQc1ODll')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+2UUjdxPTBQc1ODll')  # Support group link (make sure bot is admin)
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "False")), False)
AUTO_FFILTER = is_enabled((environ.get('AUTO_FFILTER', "True")), True)
AUTO_DELETE = is_enabled((environ.get('AUTO_DELETE', "True")), True)
DELETE_TIME = int(environ.get("DELETE_TIME", "58"))  #  deletion time in seconds (default: 5 minutes). Adjust as per your needs.
